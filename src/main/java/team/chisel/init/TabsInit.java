...
public class TabsInit {
    ...
    public static void postInit() {
        ...
        if (Features.CHISEL.enabled()) ChiselTabs.tabChisel.setTabIconItemStack(new ItemStack(ChiselItems.chisel));
        else ChiselTabs.tabChisel.setTabIconItemStack(new ItemStack(Items.stick));
        if (Features.HOLYSTONE.enabled())
            ChiselTabs.tabStoneChiselBlocks.setTabIconItemStack(new ItemStack(ChiselBlocks.holystone));
        else ChiselTabs.tabStoneChiselBlocks.setTabIconItemStack(new ItemStack(Blocks.stonebrick));
        if (Features.WOOD.enabled())
            ChiselTabs.tabWoodChiselBlocks.setTabIconItemStack(new ItemStack(ChiselBlocks.planks[0], 1, 1));
        else ChiselTabs.tabWoodChiselBlocks.setTabIconItemStack(new ItemStack(Blocks.planks));
        if (Features.TECHNICAL.enabled())
            ChiselTabs.tabMetalChiselBlocks.setTabIconItemStack(new ItemStack(ChiselBlocks.technical));
        else ChiselTabs.tabMetalChiselBlocks.setTabIconItemStack(new ItemStack(Blocks.iron_block));
        ...
        if (atLeastOneModIsLoaded) {
            if (Features.ARCANE.enabled()) {
                ...
                else ChiselTabs.tabModdedChiselBlocks.setTabIconItemStack(new ItemStack(Blocks.obsidian));
            }
        }
    }
}
